...
st.markdown(cmn_constants.css_button_primary,
...
if opt_model_id in opt_model_id_list_sd3:
    ...
    tab_basic, tab_notes = st.tabs(["Basic", "Notes"])
    ...
    with tab_notes:
        ...
        Stable Image Ultra offers enhanced creativity and photorealism, rendering exceptional visuals with highly detailed 3D imagery that include fine details like lighting, textures, and hands. The model boasts proficiency in generating images with multiple subjects, making it ideal for creating complex scenes..
        ...
        **Use Case Example:** A luxury brand uses Stable Image Ultra to create stunning visuals of its latest collection for magazine spreads, ensuring a premium feel that matches its high standards.
        ...
        st.markdown("""
        #### Stable Diffusion 3 Large: High-Quality, High-Quantity Creative Assets
        
        This model offers greatly improved performance in multi-subject prompts, image quality, and spelling abilities. SD3 Large introduces a new state-of-the-art architecture for image generation, comprising an 8 billion parameter ensemble pipeline that delivers unprecedented quality, ease of use, and the ability to create complex compositions with basic natural language prompting.
        ...
        **Use Case Example:** A game development team uses SD3 Large to create detailed environmental textures and character concepts, accelerating their creative pipeline.
        ...
        Create images quickly and affordably with this 2.6 billion parameter model, the flagship service that requires no prompt engineering to get high quality images in diverse styles. Capabilities include improved scene layout, including object placement, versatility and readability across different sizes and applications.
